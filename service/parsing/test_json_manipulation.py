...
class JsonEncodingTest(TestCase):
    ...
    def test_encode_event_collection_properly_into_json(self):
        expected_json_string = """{"Events": [{"Created at": "2012-04-05 00:00:00", "Message": "Content"}, {"Created at": "2014-12-12 00:00:00", "Message": "Yet another content"}]}"""

        actual_json_repr = self.object_under_test.encode(self.events)

        self.assertEqual(expected_json_string, actual_json_repr)

    def test_encoding_empty_list(self):
        expected_json_string = """{"Events": []}"""
